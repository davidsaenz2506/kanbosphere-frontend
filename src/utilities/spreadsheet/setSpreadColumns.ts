...
export function setSpreadColumns(data: any, setUserTasks: (value: any) => void, setCurrentSpreadData: React.Dispatch<React.SetStateAction<ISpreadSheet>>, newColumn: any) {
    let newUserRows = [];
