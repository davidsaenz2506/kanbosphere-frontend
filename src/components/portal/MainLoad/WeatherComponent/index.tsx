      ...
      <div className={styles.weatherCard}>
        <div className={styles.currentLocation}>
          ...
          <p style={{ fontSize: "50px" }}>
            {currentUserWeather?.main?.temp}° C{" "}
          </p>

          <p>{currentUserWeather?.name}</p>
          <p>Humedad {currentUserWeather?.main?.humidity}% </p>
          <p>
            Temperatura minima del dia {currentUserWeather?.main?.temp_min}° C{" "}
          </p>
          <p>
            Temperatura maxima del dia {currentUserWeather?.main?.temp_max}° C{" "}
          </p>
        </div>
