        ...
        >
          ...
          >
            ...
            <Box>
              ...
              <Tooltip label="Su ID se establece cuando crea su cuenta de Fylent, lamentablemente no es reversible.">
                <Input
                  variant="filled"
                  sx={{ backgroundColor: "rgba(0, 0, 0, 0.06)" }}
            ...
            <Box>
              ...
              <Tooltip label="Su nombre de usuario se establece cuando crea su cuenta de Fylent, lamentablemente no es reversible.">
                <Input
                  variant="filled"
                  sx={{ backgroundColor: "rgba(0, 0, 0, 0.06)" }}
